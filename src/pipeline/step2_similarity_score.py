...
class FrameSimilarityCalculator:
    ...
    def log_dataset_summary(self, dataset_name: str, video_results: Dict[str, Dict]):
        ...
        if self.logger:
            ...
            if all_mean_similarities:
                summary_metrics[f'dataset_summary/{dataset_name}/overall_mean_similarity'] = np.mean(all_mean_similarities)
    ...
    def run(self):
        ...
        try:
            ...
            return {
                "step": 2,
                "description": "Compute frame-text similarity scores",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--similarity_query", type=str, default="video summary", help="相似度查询文本")
